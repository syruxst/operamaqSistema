...
<body>
    <div class="container">
        <center><h4>PRUEBAS</h4></center>
        <?php if ($perfil == 'administrador' || $perfil == 'calidad' || $perfil == 'coordinador') { ?>
        <div class="tabla">
            <div class="row">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Nombre del Prueba" name="nombre" id="nombre">
        ...
        <?php } ?>
        <hr>
        <input type="text" name="buscar" id="buscar" placeholder="Buscar Prueba" class="form-control">
        <br>
