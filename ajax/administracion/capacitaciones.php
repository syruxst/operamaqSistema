...
<body>
    <div class="container">
        <center><h4>CAPACITACION DEL PERSONAL</h4></center>
        <?php if ($perfil == 'administrador' || $perfil == 'calidad') { ?>
        <div class="tabla">
            <div class="row">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Nombre del Funcionario" name="nombre" id="nombre" onkeyup="capitalizarNombre()">
                    <input type="text" class="form-control" placeholder="Nombre de la Capacitación" name="cargo" id="cargo">
