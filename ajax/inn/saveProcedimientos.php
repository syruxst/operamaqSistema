...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $ruta = 'procedimientos/' . $archivoNombre;
    ...
    if (move_uploaded_file($archivoTmpName, $ruta)) {
        ...
        if ($conn) {
            ...
            $sql = "INSERT INTO `procedimientosINN` (nombre, codigo, version, ruta) VALUES ('$nombreEscapado', '$codigoEscapado', '$versionEscapada', '$rutaEscapada')";
