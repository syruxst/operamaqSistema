...
<body>
    <div class="container">
        <center><h4>CONSTITUCIÓN SOCIEDAD</h4></center>
        <div class="tabla">
            <div class="row">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Nombre Empresa" name="nombre" id="nombre" onkeyup="capitalizarNombre()">
                    <input type="text" class="form-control" placeholder="Tipo Documento" name="cargo" id="cargo">
