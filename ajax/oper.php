...
<body>
<div class="logo">
    <img src="../img/logo3.png" width="210"></ing>
</div>
<br>
    <center><span class="cabecera">GESTIÓN OPERADORES</span></center>
<div class="contenido">
<div class="fijo">
  <table border="0" width="100%" style="font-size: 12px; border-collapse: collapse;" cellspacing="8" cellpadding="8" class="tboper">
    <tr>
        ...
        <td align="center">
              <span class="titulo">CRITERIO</span>
        </td>
        <td align="center">
            <span class="titulo">EXPERIENCIA</span>
        </td>
        <td align="center">
