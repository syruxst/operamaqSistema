        ...
        <div class="tabla">
            ...
            <div class="row">
                <div class="input-group">
                    <input type="checkbox" id="evaluador" name="rol" value="evaluador">  <label for="evaluador"> &nbsp;Inspector</label> &nbsp; &nbsp;
                    <input type="checkbox" id="calidad" name="rol" value="calidad">  <label for="calidad"> &nbsp;Calidad</label> &nbsp; &nbsp;
                    <input type="checkbox" id="coordinador" name="rol" value="coordinador">  <label for="coordinador"> &nbsp;Jefe Tecnico</label> &nbsp; &nbsp;
