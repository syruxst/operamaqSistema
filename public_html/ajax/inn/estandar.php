...
<body>
    <div class="container">
        <center><h4>ESTANDAR MINERO</h4></center>
        ...
        <div class="tabla">
            <div class="row">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Minera" name="cargo" id="cargo">
                    <input type="text" class="form-control" placeholder="Rev" name="rev" id="rev">
...
document.getElementById('enviar').addEventListener('click', function() {
    ...
    if (nombre.trim() === '' || cargo.trim() === '' || rev.trim() === '') {
        swal({
