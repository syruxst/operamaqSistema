...
<body>
    <div class="container">
        <center><h4>DESCRIPTOR DE CARGOS</h4></center>
        <?php if ($perfil == 'administrador' || $perfil == 'calidad') { ?>
            <div class="tabla">
                <div class="row">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Nombre del Descriptor" name="nombre" id="nombre">
        ...
        <?php } ?>
        <hr>
        <input type="text" name="buscar" id="buscar" placeholder="Buscar Descriptor" class="form-control">
        <br>
